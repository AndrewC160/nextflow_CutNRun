...
#   tibble(param_list$npks_pool,"pool","treat"),
#   tibble(param_list$sums_pool,"pool","summits"),
#   tibble(param_list$bpks_pool,"pool","treat"),
#   tibble(param_list$npks_reps,"reps","treat"),
#   tibble(param_list$bpks_reps,"reps","treat")
#   ) %>% lapply(function(tb) {
#     colnames(tb) <- c("file","set","type")
#     return(tb)
#   }) %>% do.call(rbind,.) %>%
...
#          samp = gsub("_[^_]+$","",name),
#          dir = file.path(params$output_dir,"pooled",params$pool_name))
# Source R functions.
